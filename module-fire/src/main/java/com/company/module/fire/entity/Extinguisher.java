 ...
 * - InstallDate: 제조일 (기존 ASP.NET의 InstallDate 표기는 제조일)
...
public class Extinguisher {
    ...
    private int replacementCycleYears = 5;
    ...
    private void calculateReplacementDueDate() {
        if (this.installDate != null && this.replacementCycleYears > 0) {
            this.replacementDueDate = this.installDate.plusYears(this.replacementCycleYears);
        }
    }
    ...
    public Extinguisher(String serialNumber, Building building, Floor floor,
                        ...
                        LocalDate installDate, int replacementCycleYears,
        ...
        this.replacementCycleYears = replacementCycleYears > 0 ? replacementCycleYears : 5;
    ...
    public void update(Building building, Floor floor, ExtinguisherGroup group,
                       String extinguisherType, LocalDate installDate,
