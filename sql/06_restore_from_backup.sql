...
INSERT INTO extinguisher 
  (extinguisher_id, serial_number, building_id, floor_id, extinguisher_type, install_date, replacement_cycle_years, replacement_due_date, quantity, note_key, created_at)
VALUES
