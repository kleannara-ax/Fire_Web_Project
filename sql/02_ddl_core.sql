...
-- -----------------------------------------------------------------------
-- 구역 마스터 (module-fire)
-- 기존 ASP.NET: Zone 테이블 (Zones)
-- -----------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS zone (
    zone_id         BIGINT          NOT NULL AUTO_INCREMENT COMMENT '구역 ID',
    zone_code       VARCHAR(50)     NOT NULL                COMMENT '구역 코드',
    zone_name       VARCHAR(200)                            COMMENT '구역명',
    building_id     BIGINT                                  COMMENT '건물 FK',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='구역 마스터';
